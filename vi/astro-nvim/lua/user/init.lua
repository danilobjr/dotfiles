local config = {
  ...
  mappings = {
    ...
    n = {
      ...
      ["<M-j>"] = { function() require("smart-splits").move_cursor_left() end, desc = "Move to left split" },
      ["<M-k>"] = { function() require("smart-splits").move_cursor_down() end, desc = "Move to below split" },
      ["<M-l>"] = { function() require("smart-splits").move_cursor_up() end, desc = "Move to above split" },
      ["<M-;>"] = { function() require("smart-splits").move_cursor_right() end, desc = "Move to right split" },
